...
Although these categories are pretty different, I currently prefer to have all of these functions within a single package (rather than a separate package, e.g., for RSA), as there doesn't seem to be any benefit to splitting them up at this point.
